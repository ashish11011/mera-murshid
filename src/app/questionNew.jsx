    ...
    <div className="min-h-screen w-full bg-[#0c0c0c] flex flex-col items-center justify-center text-[#ff7a00] px-4 font-mono">
      ...
      >
        ...
        <div
          ...
          //   onDragEnd={handleDragEnd}
          //   animate={controls}
          className="rounded-xl h-40 bg-[#0c0c0c] text-center text-2xl leading-relaxed font-medium flex items-center justify-center px-4 select-none shadow-lg border border-[#ff7a00]/40 text-[#ff7a00]"
        >
          {questions[index]}
        </div>
        ...
        <div className="flex justify-around mt-6 gap-4">
          ...
          >
            ...
            <span className="mt-1 text-sm text-green-400 font-medium">Yes</span>
          </button>
        </div>
      </motion.div>
    </div>
